...
public class AdapterNu extends RecyclerView.Adapter<AdapterNu.ViewHolder> {
    Context context;
    List<ForMW> forMWS;

    public AdapterNu(Context context, List<ForMW> forMWS)
    {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.custom_layout_recyclerview_nu,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //hot key
        AdapterKeywordNu adapterKeywordNu = new AdapterKeywordNu(context,forMW.getKey());
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(context,2,GridLayoutManager.HORIZONTAL,false);//spanCount:số dòng hiển thị trên 1 cột
        holder.recyclerViewKey.setLayoutManager(layoutManager);
        holder.recyclerViewKey.setAdapter(adapterKeywordNu);
       // adapterKeywordNu.notifyDataSetChanged();//notifyDataSetChanged only works if you use the add(), insert(), remove(), and clear() on the Adapter.
